"""It's port of CreateMeasurements.java from original challenge Java repository."""
...
class WeatherStation:
    ...
    def measurement(self) -> float:
        m = normalvariate(self.mean_temperature, 10.0)
...
@command("create-measurements")
@argument("file", type=Path)
@option("--records", type=int, default=1_000_000_000, help="Number of records to generate")
def main(file: Path, records: int) -> None:
